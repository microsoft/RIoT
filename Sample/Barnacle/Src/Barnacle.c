...
__attribute__((section(".PURW.Private"))) const BARNACLE_IDENTITY_PRIVATE CompoundId;
__attribute__((section(".PURW.Public"))) const BARNACLE_CERTSTORE CertStore;
...
bool BarnacleVerifyAgent()
{
    ...
    // Copy the cached identity to the cert store
